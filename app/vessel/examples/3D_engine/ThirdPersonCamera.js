...
import { Vessel } from "../../build/vessel"
...
class ThirdPersonCamera {
	...
	_CalculateIdealOffset() {
		const idealOffset = new THREE.Vector3(-100, 20, 0)
		const rotation = new THREE.Euler(0, this._params.rotation._z, 0, "XYZ")
	...
	_CalculateIdealLookat() {
		const idealLookat = new THREE.Vector3(200, 0, 0)
		const rotation = new THREE.Euler(0, this._params.rotation._z, 0)
