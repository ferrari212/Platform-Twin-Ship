...
Axios.defaults.baseURL =
  process.env.BACKENDURL || "https://platform-twin-ship.herokuapp.com";
...
class ThreeModelGLB extends Component {
  ...
  addShip = () => {
    ...
    try {
      ...
      console.error("Not possible to set the Decoder, probably it is an issue with the raw cdn content")
    }
    ...
    var url = this.ship.attributes.GLTFUrl;
    // var url = "https://ferrari212.github.io/vesseljs/examples/3D_models/GLTF/GunnerusDraco.glb"
  ...
  startAnimationLoop = () => {
    ...
    this.intersected = renderRayCaster(
      this.mouse,
      this.camera,
      this.scene,
      this.intersected
  ...
  render() {
    ...
    return (
      <Page title="Three-js" className="" wide={this.props.wide}>
        ...
        <div
          id="loader-wrapper"
          style={{ top: this.top, height: this.height, fontStyle: "italic" }}
        >
          <div>
